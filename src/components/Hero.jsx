        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          >
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-slate-800/60 to-slate-900/60 p-4 sm:p-6 shadow-2xl">
              <div className="aspect-[16/10] rounded-xl bg-[url('https://images.unsplash.com/photo-1511919884226-fd3cad34687c?ixlib=rb-4.1.0&auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center" />
